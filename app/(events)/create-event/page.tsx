...
export default function CreateEvent() {
  ...
  const addHashtag = () => {
    if (
      currentHashtag.trim() &&
      !form.getValues().hashtags.includes(currentHashtag.trim())
    ) {
      form.setValue("hashtags", [
        ...form.getValues().hashtags,
        currentHashtag.trim(),
      ]);
      setCurrentHashtag("");
    }
              ...
              render={({ field }) => (
                <FormItem className="space-y-4">
                  <div className="flex items-center gap-2">
                    ...
                    <FormLabel className="text-popover-foreground/90">
                      Event Name
                    </FormLabel>
                  </div>
                  <FormControl>
                          ...
                          {field.value ? (
                            <>
                              ...
                              <Button
                                ...
                                className="border-white/20 text-popover-foreground hover:bg-white/20"
                                onClick={() =>
                                  form.setValue("isUnlimitedCapacity", false)
                                }
                              >
                                Set Limit
                              </Button>
                            ...
                            <>
                              ...
                              <Button
                                ...
                                className="border-white/20 text-popover-foreground hover:bg-white/20"
                                onClick={() =>
                                  form.setValue("isUnlimitedCapacity", true)
                                }
                              >
                                Unlimited
                              </Button>
